...
# Адрес вашего фронтенда на GitHub Pages
FRONTEND_URL = "https://gaiijiin.github.io/Gaiijiin-bookshelf.github.io"
...
logger.info(f"✅ Бот и API запущены. Фронтенд: {FRONTEND_URL}")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [[InlineKeyboardButton("📚 Открыть Bookshelf", web_app=WebAppInfo(url=FRONTEND_URL))]]
